...
public class HomeMessages extends MessageConfig {
    ...
    public static Message HOME_LIMIT = new Message("home-limit", PREFIX + "You have reached the maximum homes [<#bc7dff>$%amt%/%max%<white>]", "The message sent when a player reaches the maximum amount of homes.");
    ...
    public static Message TELEPORT_COST = new Message("teleport-cost", PREFIX + "It cost you [<#bc7dff>$%cost%<white>] to teleport to [<#bc7dff>%home%<white>]", "The message sent when it cost money to teleport a player.");
