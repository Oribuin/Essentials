...
public class HomeConfig extends AddonConfig {
    ...
    // Module Options
    public static Option<List<String>> DISABLED_WORLDS = new Option<>("disabled-worlds", List.of("world_nether", "world_the_end"), "Homes cannot be set in these worlds.");

    // Teleport Options
    public static Option<Integer> TP_DELAY = new Option<>("teleport-delay", 5, "The delay in seconds before teleporting to a home.", "This will be overwritten with the permission 'essentials.home.bypass.delay'");
    public static Option<Integer> TP_COOLDOWN = new Option<>("teleport-cooldown", 30, "The cooldown in seconds between teleporting to homes.", "This will be overwritten with the permission 'essentials.home.bypass.cooldown'");
