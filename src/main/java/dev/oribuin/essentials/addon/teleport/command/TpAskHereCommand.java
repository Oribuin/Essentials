...
public class TpAskHereCommand {
    ...
    public TpAskHereCommand(TeleportAddon addon) {
        this.addon = addon;
    ...
    public void execute(Player sender, Player target) {
        ...
        messages.getTeleportHereAskReceived().send(target, placeholders);
        messages.getTeleportHereAskSelf().send(sender, placeholders);
