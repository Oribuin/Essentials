...
public class TeleportMessages extends MessageConfig {
    ...
    public static Message DISABLED_WORLD = new Message("disabled-world", PREFIX + "You are not allowed to teleport to the world.");
    ...
    public static Message TELEPORT_FAILED = new Message("teleport-failed", PREFIX + "Your teleport request was not successful. Please contact an admin about this.");
    public static Message TELEPORT_COST = new Message("teleport-cost", PREFIX + "It cost you [<#bc7dff>$%cost%<white>] to teleport to [<#bc7dff>%target%<white>]");
    ...
    public static Message INSUFFICIENT_FUNDS = new Message("insufficient-funds", PREFIX + "You do not have enough money to accept this teleport");
    public static Message TELEPORT_SELF = new Message("teleport-self", PREFIX + "You cannot send a teleport request to yourself");

    // Back Command
    public static Message TELEPORT_BACK = new Message("teleport-back", PREFIX + "You have teleported back to your previous location");
    public static Message TELEPORT_BACK_INVALID = new Message("teleport-back-invalid", PREFIX + "You do not have a location you previously teleported from");
