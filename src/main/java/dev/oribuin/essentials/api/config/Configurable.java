...
public interface Configurable {
     ...
     * <p>
     * This an optional method and should only be used if the Configurable class is its own file
     *
    ...
    default File parentFolder() {
        return EssentialsPlugin.get().getDataFolder();
    }
     ...
     */
    default void reload() {
        EssentialsPlugin plugin = EssentialsPlugin.get();
