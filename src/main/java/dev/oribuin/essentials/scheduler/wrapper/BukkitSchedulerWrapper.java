package dev.oribuin.essentials.scheduler.wrapper;

import dev.oribuin.essentials.EssentialsPlugin;
import dev.oribuin.essentials.scheduler.task.BukkitScheduledTask;
...
public class BukkitSchedulerWrapper implements SchedulerWrapper {
    ...
    public BukkitSchedulerWrapper(EssentialsPlugin javaPlugin) {
