...
public enum Weather {
     ...
     * @param duration How long the weather state will last
     */
    public void apply(Location location, Duration duration) {
        this.apply(location, duration != null ? (int) duration.toSeconds() : 0);
    }
