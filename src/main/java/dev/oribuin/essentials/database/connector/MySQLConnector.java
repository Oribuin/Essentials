...
public class MySQLConnector implements DatabaseConnector {
    ...
    public MySQLConnector(EssentialsPlugin javaPlugin, String hostname, int port, String database, String username, String password, boolean useSSL, int poolSize) {
